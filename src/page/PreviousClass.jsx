...
const PreviousClass = () => {
  ...
  const handleViewAttendance = (classItem) => {
    // Open modal; AttendanceListModal will fetch attendees by courseId
    setSelectedClass(classItem);
    setIsModalOpen(true); // modal will fetch attendees directly
  };
  ...
  return (
    <>
      <section className="pb-20 pt-8 px-6 max-w-7xl mx-auto h-[calc(100vh-6rem)]">
        ...
        {/* Attendance Modal */}
        <AttendanceListModal isOpen={isModalOpen} courseId={selectedClass?.course_id} onClose={handleCloseModal} />
      </section>
      <Footer />
    </>
  );
